...
MSYS_NO_PATHCONV=1 docker-compose exec --user root iris bash -c "find /home/irisowner/intro-to-iris-instruqt -type f \( -name 'setup-iris' -o -name 'solve-iris' -o -name 'check-iris' \) | xargs sed -i 's/\r//'"
